        ...
        <FadeIn>
          <div className="w-full max-w-5xl">
            <h1 className="max-w-full leading-[0.96] tracking-[-0.035em]">
              <span className="block text-[2.75rem] font-medium text-white sm:text-6xl md:text-7xl lg:text-[5.8rem] xl:text-[6rem]">
                Creating
              </span>

              <span className="mt-2 block text-[3.1rem] font-semibold text-teal-300 sm:text-7xl md:text-8xl lg:text-[6.9rem] xl:text-[7.8rem]">
                Better
              </span>

              <span className="block text-[3.1rem] font-semibold text-teal-300 sm:text-7xl md:text-8xl lg:text-[6.9rem] xl:text-[7.8rem]">
                Environments
              </span>
            </h1>
